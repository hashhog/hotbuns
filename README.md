...
- [x] RPC server (JSON-RPC 2.0, Bitcoin Core-compatible: getblockchaininfo, getblock, getblockheader, getblockhash, getrawtransaction, sendrawtransaction, getmempoolinfo, getrawmempool, estimatesmartfee, getpeerinfo, getnetworkinfo, validateaddress, getblocktemplate)
